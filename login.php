...
<body>
	...
	<form action="pedulidiri/home.php" method="post">
		<div class="content">
			<div class="card-login">
				<div class="card-main">
					...
					<div class="card-body">
						...
						<p style="text-align: center;">Belum punya akun?<span><a href="<?= "pedulidiri/register.php" ?>" class=""> Daftar disini</a></span></p>
					</div>
				</div>
			</div>
		</div>
